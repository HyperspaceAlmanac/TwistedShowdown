...
local mission1_1 = {
    ...
    },
    {
        ...
        objects = {
            {},
            {
                { template = Generator, position = Vector3.New(-22250, 21200, -2350), scale = Vector3.New(3, 3, 3), health = 100 },
                { template = Generator, position = Vector3.New(-22500, 14100, -2350), scale = Vector3.New(3, 3, 3), health = 100 },
                { template = Generator, position = Vector3.New(-30350, 13550, -2350), scale = Vector3.New(3, 3, 3), health = 100 }
            }, {}, {}
        }
    },
    {
        ...
        objects = {
            {}, {},
            {
                { template = Humidifier, position = Vector3.New(-23950, 18950, -4050), scale = Vector3.New(5, 5, 5), rotation = Rotation.New(180, 0, 0), health = 100 },
                { template = Humidifier, position = Vector3.New(-24350, 12650, -4050), scale = Vector3.New(5, 5, 5), rotation = Rotation.New(180, 0, 0), health = 100 },
                { template = Humidifier, position = Vector3.New(-29900, 16450, -4050), scale = Vector3.New(5, 5, 5), rotation = Rotation.New(180, 0, 0), health = 100 }
            }, {}
        }
    },
    {
        ...
        objects = {
            {
                ...
                { template = Generator, position = Vector3.New(-25850, 12950, -2050), scale = Vector3.New(3, 3, 3), health = 100 },
                { template = Generator, position = Vector3.New(-25850, 19050, -2050), scale = Vector3.New(3, 3, 3), health = 100 }
            }, {}, {}
        }
    },
    {
        ...
        objects = {
            {}, {
                { template = Generator, position = Vector3.New(-29000, 20100, -1800), scale = Vector3.New(3, 3, 3), health = 100 },
                { template = Generator, position = Vector3.New(-29000, 12550, -1800), scale = Vector3.New(3, 3, 3), health = 100 }
            }, {
                { template = Humidifier, position = Vector3.New(-22700, 18000, -4050), scale = Vector3.New(5, 5, 5), rotation = Rotation.New(180, 0, 0), health = 100 },
                { template = Humidifier, position = Vector3.New(-22700, 14850, -4050), scale = Vector3.New(5, 5, 5), rotation = Rotation.New(180, 0, 0), health = 100 }
            }, {}
        }
    },
    {
        ...
        objects = {
            {
                ...
                { template = Generator, position = Vector3.New(-27000, 18550, -1800), scale = Vector3.New(3, 3, 3), health = 100 },
                { template = Generator, position = Vector3.New(-27000, 13750, -1800), scale = Vector3.New(3, 3, 3), health = 100 }
            }, {
                { template = Humidifier, position = Vector3.New(-30500, 20950, -4050), scale = Vector3.New(5, 5, 5), rotation = Rotation.New(180, 0, 0), health = 100 },
                { template = Humidifier, position = Vector3.New(-30500, 11650, -4050), scale = Vector3.New(5, 5, 5), rotation = Rotation.New(180, 0, 0), health = 100 }
            }, {}
        },
    }
}
